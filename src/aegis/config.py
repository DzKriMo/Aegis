...
class Settings:
    def __init__(self):
        ...
        self.aegis_semantic_enabled = _get_bool("AEGIS_SEMANTIC_ENABLED", True)
        ...
        self.aegis_ollama_base_url = (_get("AEGIS_OLLAMA_BASE_URL", "http://127.0.0.1:11434") or "http://127.0.0.1:11434").rstrip("/")
        default_chat_endpoint = f"{self.aegis_ollama_base_url}/v1/chat/completions"
        default_model_name = _get("AEGIS_DEFAULT_OLLAMA_MODEL", "qwen2.5:7b-instruct")
        self.aegis_llm_endpoint = _get("AEGIS_LLM_ENDPOINT", default_chat_endpoint)
        self.aegis_llm_timeout = _get_int("AEGIS_LLM_TIMEOUT", 45)
        self.aegis_llm_model = _get("AEGIS_LLM_MODEL", default_model_name)
        ...
        self.aegis_model_timeout = _get_int("AEGIS_MODEL_TIMEOUT", 90)
        ...
        self.aegis_local_classifier_enabled = _get_bool("AEGIS_LOCAL_CLASSIFIER_ENABLED", True)
